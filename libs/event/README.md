...
The sequence diagram for this library can be found at [/docs/F001/F001_eventAnlegen_seq.plantuml](/docs/F001/F001_eventAnlegen_seq.plantuml)
...
The Test-Cases for this library can be found at [/apps/party-time-frontend-e2e/src/e2e/create.event.cy.ts](/apps/party-time-frontend-e2e/src/e2e/create.event.cy.ts)
...
The sequence diagram for this library can be found at [/docs/F002/F002_eventsBearbeiten_seq.plantuml](/docs/F002/F002_eventsBearbeiten_seq.plantuml)
...
The Test-Cases for this library can be found at [/apps/party-time-frontend-e2e/src/e2e/change.event.cy.ts](/apps/party-time-frontend-e2e/src/e2e/change.event.cy.ts)
...
The sequence diagram for this library can be found at [/docs/F003/F003_eventsLoeschen_seq.plantuml](/docs/F003/F003_eventsLoeschen_seq.plantuml)
...
The Test-Cases for this library can be found at [/apps/party-time-frontend-e2e/src/e2e/delete.event.cy.ts](/apps/party-time-frontend-e2e/src/e2e/delete.event.cy.ts)
...
The sequence diagram for this library can be found at [/docs/F016/F016_eventsUeberblicken_seq.plantuml](/docs/F016/F016_eventsUeberblicken_seq.plantuml)
...
The Test-Case for this library can be found at [/apps/party-time-frontend-e2e/src/e2e/overview.cy.ts](/apps/party-time-frontend-e2e/src/e2e/overview.cy.ts)
...
The sequence diagram for this library can be found at [/docs/F004/F004_gaesteEinladen_seq.plantuml](/docs/F004/F004_gaesteEinladen_seq.plantuml)
...
The Test-Cases for this library can be found at [/apps/party-time-frontend-e2e/src/e2e/participants.cy.ts](/apps/party-time-frontend-e2e/src/e2e/participants.cy.ts)
...
The sequence diagram for this library can be found at [/docs/F005/F005_gaesteAusladen_seq.plantuml](/docs/F005/F005_gaesteAusladen_seq.plantuml)
...
The sequence diagram for this library can be found at [/docs/F006/F006_teilnehmerUeberblicken_seq.plantuml](/docs/F006/F006_teilnehmerUeberblicken_seq.plantuml)
...
The sequence diagram for this library can be found at [/docs/F018/F018_WegbeschreibungZumEvent_seq.plantuml](/docs/F018/F018_WegbeschreibungZumEvent_seq.plantuml)
